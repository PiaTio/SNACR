...
#'
#'Finds a range of lasso tuning parameters for the common component so as to generate sparse common component. From R package \code{RegularizedSCA} (Gu & Van Deun, 2016).
#'
