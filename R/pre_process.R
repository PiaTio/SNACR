#' Standardize data
#'
#' Standardize the given data matrix per column, over the rows, with multiple imputation for missing data. From R package \code{RegularizedSCA} (Gu & Van Deun, 2016).
#'
